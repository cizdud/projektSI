 ...
 */
final class Version20240623130123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE events ADD event_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE author_id author_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE events DROP event_date, CHANGE author_id author_id INT DEFAULT NULL');
    }
}
